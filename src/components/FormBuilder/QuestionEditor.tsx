...
export const QuestionEditor: React.FC<QuestionEditorProps> = ({
  ...
  const handleLabelChange = (newLabel: string) => {
    ...
    // Only auto-generate ID for empty or clearly auto-generated IDs
    const currentId = question.id;
    const isEmpty = !currentId || currentId.trim() === '';
    // Be very specific about what constitutes a generated ID - avoid UUIDs and meaningful IDs
    const isAutoGenerated = /^(ny_|temp_|question_\d+|fraga_\d+)/.test(currentId);
    
    // Only auto-generate for truly empty or auto-generated IDs, not meaningful existing IDs
    if ((isEmpty || isAutoGenerated) && newLabel.trim()) {
